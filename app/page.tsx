...
export default function Home() {
  ...
  return (
    <div className="min-h-screen text-foreground relative transition-colors duration-300">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 sm:gap-8">
            ...
            <div className="flex items-center gap-4">
              ...
              >
                {isDark ? (
                  <svg
                    className="w-4 h-4 text-foreground group-hover:text-foreground transition-colors duration-300"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path
